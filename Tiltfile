...
local_resource(
    'Sample', 'kubectl apply -f ./config/samples/mshr_v1_sspyfamilllly.yaml',
    deps=["./config/samples/mshr_v1_sspyfamilllly.yaml"])

docker_build('schemaspy:latest', './example/docker', dockerfile = './example/docker/Dockerfile.schemaspy')
# k8s_yaml('./example/manifests/schemaspy.yaml')
